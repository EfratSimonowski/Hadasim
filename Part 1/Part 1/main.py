...
<<<<<<< HEAD
"""
האלגוריתם עובר על כל M השורות בקובץ הלוגים כדי לספור מופעים של קודי שגיאה שונים, ולכן שלב זה לוקח O(M) זמן. לאחר מכן
הוא מוצא את N השגיאות השכיחות ביותר מתוך K קודים ייחודיים (כאשר K ≤ M), באמצעות מבנה heap בגודל N. שלב זה מבוצע בזמן O(K log N)
לכן, זמן הריצה הכולל של האלגוריתם הוא O(M + K log N).
מבחינת זיכרון, האלגוריתם שומר טבלת שכיחויות בגודל K ולכן צורך O(K) מקום בזיכרון.
"""
=======
>>>>>>> 55fc0f741f4f063ed970c748f751baceb2cbbefd
